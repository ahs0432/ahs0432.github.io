...
이번에는 이름이 조금 다른데 `자기 주도`를 통해 자격 관련 문서를 통해 관련 내용 습득이 가능하다.  
...
## 결과
시험 결과는 `852점`이라는 나름 준수한(?) 성적으로 시험을 합격할 수 있었다.

처음으로 `Dump`의 전체 문제를 받고 본 시험인데 나름 익숙한 문제들이 80% 정도 출제됐다.  
역시 최신 문제까지 갱신된 문제를 보면 시험의 출제 빈도 자체각 다르구나라는 생각이 들었다.
