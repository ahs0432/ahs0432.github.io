...
![](/assets/image/Post/Computing/OS/Linux/CentOS/CentOS-OpenVPN-Private-Connect-MySQL/1.png =70%x70%)
* 사진과 같이 `VPN` 연결을 진행하지 않고 Test Page 접속 시 DB 연결에 실패가 확인됩니다.
  
![](/assets/image/Post/Computing/OS/Linux/CentOS/CentOS-OpenVPN-Private-Connect-MySQL/2.png =70%x70%)
* 이 상태에서 `OpenVPN Client`를 실행하여 `OpenVPN Server`로 정상 연결되는지 우선 확인합니다.
  
![](/assets/image/Post/Computing/OS/Linux/CentOS/CentOS-OpenVPN-Private-Connect-MySQL/3.png =70%x70%)
