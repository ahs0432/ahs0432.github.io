...
* [[Network] REST API란? (RESTful API)](/posts/Computing/Structure/REST-API-Structure.html)
:::
...
![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/1.png =90%x90%)
...
![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/2.png =90%x90%)
...
![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/3.png =90%x90%)
...
![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/4.png =90%x90%)
...
![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/5.png =90%x90%)
- 현재 상태에서는 정보가 1개 뿐이기 때문에 제한 값을 확인할 수 없다.
- 그래서 POST를 이용해서 30개의 정보를 동일 값으로 지정하여 추가하였다.

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/6.png =90%x90%)
- 이렇게 조회할 경우 현재 offset이 기본 값(1)이므로 1부터 25개가 조회된다.

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/7.png =90%x90%)
- 나머지 5개는 offset을 26부터로 지정할 경우 확인이 가능하다.

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/8.png =90%x90%)
...
![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/9.png =90%x90%)
- 자원 ID에 값만 존재한다면 사진과 같이 정상적으로 값이 조회된다.

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/10.png =90%x90%)
- 만약 31번과 같이 존재하지 않는 자원 ID를 조회할 경우 오류가 발생된다.

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/11.png =90%x90%)
- 또한 ID 값이 정수 값이 아닌 경우에도 오류가 발생된다.

### 📝 PUT 요청 테스트 (PUT /users/:idx)
PUT 요청을 이용해서 자원을 교체하고 어떻게 교체되는지 확인해보겠다.

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/12.png =90%x90%)

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/13.png =90%x90%)
- 1번 ID를 가진 자원을 필드 내용을 교체한 뒤 조회해보았다.

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/14.png =90%x90%)

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/15.png =90%x90%)
...
![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/16.png =90%x90%)

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/17.png =90%x90%)
- 1번 ID를 가진 자원을 필드 내용을 교체한 뒤 조회해보았다.
- 여기까진 모든 필드를 변경하기에 PUT과 동일한 결과를 보인다.

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/18.png =90%x90%)

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/19.png =90%x90%)
...
![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/20.png =90%x90%)

![](/assets/image/Post/Computing/Develop/GoLang/REST-API-Implement-GoLang/21.png =90%x90%)
